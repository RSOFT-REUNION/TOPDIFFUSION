...
class AddTires extends ModalComponent
{
    public $product;
    public $position, $width, $height, $diameter, $indice, $ugs, $ugs_swatch;
    ...
    // Fonction permettant la création de la swatch
    public function addVariant()
    {
        ...
        $variant->tire_position = $this->position;
        $variant->tire_width = $this->width;
        $variant->tire_height = $this->height;
        $variant->tire_diameter = $this->diameter;
        $variant->tire_charge = $this->indice;
    ...
    public function render()
    {
        ...
        return view('livewire.popups.back.products.product-add.add-tires', $data);
    }
}
