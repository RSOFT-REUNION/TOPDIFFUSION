    ...
    <div>
        <div id="entry-header" class="flex items-center">
            <div class="flex-1 inline-flex items-center">
                <button type="button" onclick="window.history.back()" class="btn-secondary mr-3"><i class="fa-solid fa-arrow-left"></i></button>
                ...
                <div class="flex-1 mr-2">
                    <div class="">
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-3">
                            <div class="bg-red-300 text-center py-2 rounded-md duration-300 hover:bg-secondary cursor-pointer">
                                <button onclick="Livewire.emit('openModal', 'pages.front.sav.open-ticket-sav', {{ json_encode(['user' => $order->User()->id, 'command' => $order->document_number])}})">Demande SAV</button>
                            </div>
                        ...
                        <div class="mt-3">
                            <ul>
                                @foreach($order_items as $item)
                                    <li>
                                        <div role="button" data-href="{{ route('front.product', ['slug' => $item->ProductItem->slug]) }}" class="bg-gray-100 py-2 px-3 rounded-md duration-300 border border-transparent hover:border-gray-200 hover:scale-105 hover:drop-shadow-xl cursor-pointer">
                                            <div class="flex items-center">
                                                <div class="flex-none">
