    ...
    <div class="flex flex-col h-screen">
        ...
        <div id="sidebar_entry-content" class="flex-1">
            @if($group == 'home')
                <ul>
                    ...
                    <li><a href="{{ route('back.product.list') }}" class="btn-sidebar"><i class="fa-solid fa-file-contract mr-3"></i>Commandes</a></li>
                    <li><a href="{{ route('back.product.list') }}" class="btn-sidebar"><i class="fa-solid fa-comments mr-3"></i>S.A.V</a></li>
                    <h2>Mon site</h2>
                    <li><a href="{{ route('back.product.list') }}" class="btn-sidebar"><i class="fa-solid fa-pager mr-3"></i>Pages</a></li>
                    <h2>Paramètres</h2>
                    <li><a href="{{ route('back.setting') }}" class="btn-sidebar"><i class="fa-solid fa-sliders mr-3"></i>Réglages</a></li>
                    <li><a href="{{ route('back.product.list') }}" class="btn-sidebar"><i class="fa-solid fa-people-group mr-3"></i>Équipes</a></li>
                    <li><a href="{{ route('back.product.list') }}" class="btn-sidebar"><i class="fa-solid fa-circle-info mr-3"></i>À propos</a></li>
                </ul>
            @elseif($group == 'products')
                ...
                <ul>
                    ...
                    <li><a href="{{ route('back.product.bikes') }}" class="btn-sidebar @if($page == 'discounts') btn-sidebar-active @endif"><i class="fa-solid fa-tags mr-3"></i>Promotions</a></li>
            ...
            @elseif($group == 'settings')
                ...
                <ul>
                    ...
                    <li><a href="{{ route('back.setting.avanced') }}" class="btn-sidebar @if($page == 'avance') btn-sidebar-active @endif"><i class="fa-solid fa-gear mr-3"></i>Réglages généraux</a></li>
                    <li><a href="{{ route('back.setting.perform') }}" class="btn-sidebar @if($page == 'performance') btn-sidebar-active @endif"><i class="fa-solid fa-gauge-simple-high mr-3"></i>Performances</a></li>
                </ul>
            @endif
        </div>
        <div id="sidebar_entry-footer" class="flex-none">
            <div class="inline-flex items-center justify-around w-full">
                ...
                <a href="" class="btn-icon block" title="Se déconnecter"><i class="fa-solid fa-arrow-right-to-bracket"></i></a>
            </div>
        </div>
    </div>
</div>
