<div class="flex items-center mr-2 px-2 py-1 rounded-lg border border-gray-200">
    <p class="mr-2">Mes tarifs</p>
    <label for="default-toggle" class="relative inline-flex items-center cursor-pointer">
        <input type="checkbox" wire:click="changeSettings" id="default-toggle" class="sr-only peer" @if($prices_pro == 1) checked @endif wire:click="$refresh">
