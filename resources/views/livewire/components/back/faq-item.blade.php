<div class="bg-gray-100 rounded-md p-5 mt-5">
    <div class="flex flex-row justify-between cursor-pointer" wire:click="toggleAnswer">
        ...
        <div class="flex flex-row gap-x-5 items-center">
            <a wire:click.stop="" class="cursor-pointer"><i class="fa-solid fa-pencil"></i></a>
            <a wire:click.stop="" class="cursor-pointer"><i class="fa-solid fa-trash"></i></a>
        </div>
    </div>
    @if($showAnswer)
