        ...
        <div class="flex gap-2">
            <div class="flex-1">
                ...
                <div class="">
                    ...
                    <div class="border-2 border-slate-100 rounded-xl p-4 mt-3">
                        <div class="flex items-center">
                            <div class="flex-1">
                                <h2 class="font-bold text-xl">Informations sur le produit</h2>
                                <form wire:submit.prevent="" class="mt-5">
            ...
            <div class="flex-none w-[300px]">
                ...
                <button class="block w-full bg-slate-100 mt-2 py-2 rounded-md duration-300 hover:bg-secondary hover:text-white">Modifier les stocks</button>
