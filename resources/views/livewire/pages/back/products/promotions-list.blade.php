<div>
    <div>
        ...
        <div id="entry-content">
            @if($products->count() > 0)
            <div class="flex flex-col w-[300px] cursor-pointer">
                <div class="bg-[#f0f0f0] flex flex-col gap-4 h-[300px] shrink-0 items-center p-8 rounded-lg">
                    <div class="bg-[#d9d9d9] self-stretch h-40 shrink-0 mb-2 ml-px"></div>
                        <div class="whitespace-nowrap text-center font-['Inter'] font-semibold w-3/4">
                            Nom de la promotions
                        </div>
                        <div class="whitespace-nowrap text-xl font-['Inter'] font-semibold text-[#fbbc34] w-12">
                            20 %
                        </div>
                    </div>
            </div>
