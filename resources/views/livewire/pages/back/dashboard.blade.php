<div>
    ...
    <div id="entry-content" class="mt-5">
        ...
        <div class="grid grid-cols-4 grid-rows-2 gap-5 bg-gray-100 p-5 rounded-xl">
            ...
            <div class="bg-white p-5 flex flex-col gap-y-5 rounded-lg">
            ...
            <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 row-span-2">
                <div class="flex justify-between">
                <div class="px-5 pt-5">
                    <h5 class="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">32.4k</h5>
                    <p class="text-base font-normal text-gray-500 dark:text-gray-400">Chiffre des vente réaliser</p>
                </div>
                <div
            ...
            <div class="bg-white p-5 flex flex-col gap-y-5 rounded-lg row-span-2">
                <h2 class="text-gray-500">Nombre de vente</h2>
                <div class="flex flex-row items-end">
                    <h3 class="font-bold mr-2 text-2xl">2000</h3>
                    <span class="pb-0.5">semaine</span>
