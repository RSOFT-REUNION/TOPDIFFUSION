<div id="popup">
    ...
    <div class="mx-7 my-5">
        <div class="textfield">
            ...
            <input type="text" id="question" placeholder="Entrez votre prénom" name="question" wire:model="question" class="@if($errors->has('question')) input-error @endif" value="{{ old('question') }}">
        ...
        <div class="textfield mt-2">
            ...
            <textarea type="text" id="reponse" rows="7" placeholder="Entrez votre prénom" name="reponse" wire:model="reponse" class="@if($errors->has('reponse')) input-error @endif" value="{{ old('reponse') }}"></textarea>
