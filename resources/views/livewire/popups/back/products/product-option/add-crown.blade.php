<div>
    ...
    <div class="p-5">
        <form wire:submit.prevent="addCrown" enctype="multipart/form-data">
            @csrf
            <div class="textfield">
                <label for="reference">Référence<span class="text-red-500">*</span></label>
                <input type="text" id="reference" wire:model="reference" placeholder="Entrez la référence de la pièce" class="@if($errors->has('reference')) input-error @endif" value="{{ old('reference') }}">
            ...
            <div class="textfield mt-2">
                ...
                <input type="number" id="gearing" wire:model="gearing" placeholder="Entrez la denture" class="@if($errors->has('gearing')) input-error @endif" value="{{ old('gearing') }}">
