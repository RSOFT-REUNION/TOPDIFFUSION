<div>
    <div class="bg-gray-100 p-5">
        <div class="flex items-center">
            <div class="flex-1">
                <h2 class="font-bold text-xl">Informations supplémentaires</h2>
            </div>
            <div class="flex-none">
    ...
    <div class="border-b border-gray-100 p-5 text-gray-500">
        <p>
            Ajouter des informations supplémentaires vous permet d'informer vos clients de différentes informations de manière plus rapides tel que
            pour les matériaux, leurs positions, des références supplémentaires etc...
        </p>
    </div>
